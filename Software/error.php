            ...
            <div class="row">
                <div class="col-md-5 col-md-offset-1" id="form_container">
                    <img src="img/login.png">
                        <span class="snake" style="color:red;">Student not found/Login information incorrect</span>
                    <br>
                    <form action="loginconnection.php" method="POST" class="login">
                        <input placeholder="UOB*" type="numeric" name="user" maxlength="8" onkeypress='validate(event)'>
